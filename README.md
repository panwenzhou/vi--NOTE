...
![001_vi键盘-w551](README.assets/001_vijp.png)
...
![002_删除交换文件-w1048](README.assets/del.png)
...
![003_vi的模式-w500](README.assets/003_vi的模式.png)
...
![005_移动光标-w551](README.assets/005_移动光标.png)
...
| gg | go | 文件顶部 |
| G | go | 文件末尾 |
| 数字gg | go | 移动到 数字 对应行数开头 |
| 数字G | go | 移动到 数字 对应行数开头 |
| :数字 |  | 移动到 数字 对应行数开头 |
...
| 命令 | 英文 | 功能 |
| :---: | :---: | --- |
| Ctrl + b或pgup | back | 向上翻页 |
| Ctrl + f或pgdn | forward | 向下翻页 |
| H | Head | 屏幕顶部 |
| M | Middle | 屏幕中间 |
| L | Low | 屏幕底部 |
...
| R或两次小键盘0 | replace | 替换当前行光标后的字符 | 替换模式 |
...
![004_插入命令-w400](README.assets/004_插入命令.png)
